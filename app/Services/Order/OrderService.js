...
class OrderService{
    ...
    async updateItems(items) {
        ...
        //deleta os items que o user nao quer mais
    ...
    async canApplyDiscount(coupon){
        ...
        if(now > coupon.valid_from.getTime() || (typeof coupon.valid_until == 'object' && coupon.valid_until.getTime() < now)){
            ...
            //Verifica se há uma data de expiração, se
            //houver data de expiração, verifica se o cupom expirou.
            return false
         ...
         */
          ...
          */
          ...
          /**
           * Caso nenhuma das verificações acima deem positivias
